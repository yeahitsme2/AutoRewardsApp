  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updateData = {
        ...
        supplies_rate: suppliesSettings.calc_method === 'flat_per_ro' ? 0 : suppliesSettings.rate,
        supplies_flat_amount: suppliesSettings.calc_method === 'flat_per_ro' ? suppliesSettings.flat_amount : 0,
