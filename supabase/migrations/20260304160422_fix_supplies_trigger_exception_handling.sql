/*
  # Fix Supplies Trigger Exception Handling

  1. Changes
    - Add exception handling to prevent trigger errors from bubbling up
    - Log errors instead of failing silently
    - Ensure the trigger never causes the main operation to fail
